...
export function reviewerAssignedEmail({ reviewer, article, author }: { reviewer: any; article: any; author: any }) {
  return {
    subject: 'Yeni �nceleme Talebi',
    html: `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;"><h2 style="color: #2563eb;">Merhaba ,</h2><p>Size bir makale inceleme talebi atand�:</p><div style="background: #f3f4f6; padding: 20px; border-radius: 8px; margin: 20px 0;"><h3 style="margin-top: 0;"></h3><p><strong>Yazar:</strong> </p></div><p>L�tfen sisteme giri� yaparak makalenizi inceleyin:</p><a href="/dashboard/reviewer" style="background: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px;">�ncele</a></div>`
  }
}
...
export function reviewSubmittedEmail({ editor, article, reviewer, recommendation }: { editor: any; article: any; reviewer: any; recommendation: string }) {
  const recText = { ACCEPT: 'Kabul', REJECT: 'Red', MINOR_REVISION: 'K���k Revizyon', MAJOR_REVISION: 'B�y�k Revizyon' }[recommendation] || recommendation;
  return {
    subject: 'Hakem G�r��� Al�nd�',
    html: `<div style="font-family: Arial, sans-serif;"><h2>Merhaba ,</h2><p>Bir makale i�in hakem g�r��� g�nderildi:</p><div style="background: #f3f4f6; padding: 20px; border-radius: 8px;"><h3></h3><p><strong>Hakem �nerisi:</strong> </p></div><a href="/dashboard/editor/article/" style="background: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px;">G�r�nt�le</a></div>`
  }
}
